...
<button class="center-map-button" onclick="event.stopPropagation(); openMapSelector(event)"
...
<button class="center-map-button" onclick="event.stopPropagation(); openMapSelector()">
...
<button class="rank-button" onclick="event.stopPropagation(); openRankSelector(this)">
Rank ▼
</button>
...
function openRankSelector(button){
    ...
    ranks.forEach(rank=>{
        ...
        <div class="rank-option" onclick="selectRank(this,'${rank}')">
            ${rank}
        </div>
